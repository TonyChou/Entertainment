...
public class LocationShowActivity extends AppCompatActivity implements LocationSource,
    ...
    private void setUpMap() {
        ...
        myLocationStyle.strokeColor(getResources().getColor(R.color.control_highlight_lime));// 设置圆形的边框颜色
