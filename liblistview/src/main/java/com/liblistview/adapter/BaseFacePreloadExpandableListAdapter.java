 ...
 * 
 */
package com.liblistview.adapter;
 ...
 * 
 */
public abstract class BaseFacePreloadExpandableListAdapter extends PinnedHeaderExpandableListView.ExpandableListAdapter implements AbsListView.OnScrollListener
{
     ...
     * (non-Javadoc)
     * 
     * @see android.widget.ExpandableListAdapter#getGroupView(int, boolean, View, ViewGroup)
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see com.tencent.widget.PinnedHeaderExpandableListView.ExpandableListAdapter#configHeaderView(View,
     * int)
     */
    @Override
