...
public class FMUrl {
    ...
    public static String FM_PLAYLIST_URL = "http://douban.fm/j/mine/playlist?type=%s&pt=0.0&channel=%s&pb=128&from=mainsite&r=ffdf27397";
    public static String FM_LYRIC_URL = "https://api.douban.com/v2/fm/lyric&ssid=d8d5&sid=660042";
    public static String FM_GET_CHANNEL_LIST_BY_TYPE = "http://douban.fm/j/explore/genre?gid=%s&start=%d&limit=%d";
}
